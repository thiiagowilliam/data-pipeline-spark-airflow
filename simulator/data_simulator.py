...
class DataGenerator:
    """Gera dados de clientes e vendas."""
...
class MinioUploader:
    """Faz upload de arquivos para o MinIO."""
    ...
    def upload_to_minio(self, df: pd.DataFrame, folder: str, filename: str):
        """Faz upload de um DataFrame para o MinIO como CSV."""
...
class Simulation:
    """Orquestra a simulação de geração e upload de dados."""
